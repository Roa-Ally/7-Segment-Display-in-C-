...
#include<stdlib.h>
#include <math.h>
int* toArray(int size, int number)
{
...
void seven_segment_print(int horizontal, int vertical, const int* numberArray, int size) {
...
void main(void) {
    ...
    while (1) {
        ...
        int* numberArray = toArray(size, pos_int);
        seven_segment_print(segment_width, segment_height, numberArray, size);
        break;
    }
